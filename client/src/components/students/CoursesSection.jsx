...
const CoursesSection = () => {
  ...
  return (
    <div className='py-16 md:px-40 px-8'>
      ...
      <div className="grid grid-cols-auto lg:grid-cols-4 px-4 md:px-0 md:my-16 my-10 gap-4">
      ...
      <Link to="/course-list" onClick={() => window.scrollTo(0, 0)}
        className='text-gray-500 border border-gray-500/30 px-10 py-3 rounded inline-block mt-2'
      >
        Show all courses
      </Link>
    </div>
